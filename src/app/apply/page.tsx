  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: PAGE_BG, color: TEXT_WHITE }}>
      ...
      <div className="max-w-md mx-auto p-8">
        ...
        >
          <h1 className="text-2xl font-bold mb-6" style={{ color: TEXT_WHITE }}>申込フォーム</h1>

          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2" style={labelStyle}>投資経験</label>
            ...
            <div>
              <label className="block text-sm font-medium mb-1" style={labelStyle}>投資目的</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium mb-1" style={labelStyle}>投資種別</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium mb-1" style={labelStyle}>自己資金 (円)</label>
              <input
                type="number"
                inputMode="numeric"
                min={0}
            ...
            <div>
              <label className="block text-sm font-medium mb-1" style={labelStyle}>既存ローン</label>
              <textarea
            ...
            <div>
              <label className="block text-sm font-medium mb-2" style={labelStyle}>希望サービス（複数選択可）</label>
              <div className="space-y-2">
                {SERVICE_OPTIONS.map(s => (
                  <label key={s} className="flex items-center gap-2" style={labelStyle}>
                    <input
                      type="checkbox"
          ...
          <p className="mt-6 text-xs" style={{ color: TEXT_MUTED }}>
            ご入力いただいた情報は担当者確認のうえ、最適なサービスをご提案します。
          </p>
        </div>
      </div>
    </div>
